...
<body>
    ...
    <div class="rightinfo">
        <div class="tools">
            ...
            <input type="text" name="" value="" class="dfinput"/>
            <input type="button" id="search" name="" value="搜索商品" class="btn"/>
        </div>
        <table class="tablelist">
            ...
            <tbody>
              ...
              <?php if(is_array($goods)): $i = 0; $__LIST__ = $goods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$good): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><img src="<?php echo (ltrim($good["goods_small_logo"],'.')); ?>" alt="暂无图片"/></td>
                    <td><?php echo ($good["goods_price"]); ?></td>
                    <td><?php echo ($good["goods_amount"]); ?></td>
                    <td><?php echo (date("Y-m-d H:i",$good["add_time"])); ?></td>
                    <td><?php if($good["is_show"] == '1' ): ?>显示<?php else: ?>不显示<?php endif; ?></td>
