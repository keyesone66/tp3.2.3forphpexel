  ...
  <script type="text/javascript">
    $(function(){
      ...
      $(".delete").click(function(){
        ...
        var obj = $(this);
        //异步删除
        $.get("<?php echo U('Cart/delete');?>",'id='+id,function(){
          //通过DOM操作,把这一行信息移除掉
	...
	<div class="mycart w990 mt10 bc">
        ...
        <?php if(is_array($goods)): $i = 0; $__LIST__ = $goods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$good): $mod = ($i % 2 );++$i;?><tr>
  					<td class="col1"><a href=""><img src="<?php echo (ltrim($good["goods_small_logo"],'.')); ?>" alt="" /></a>  <strong><a href=""><?php echo ($good["goods_name"]); ?></a></strong></td>
  					<td class="col3">￥<span><?php echo ($good["goods_price"]); ?></span></td>
  					<td class="col4">
  						<a href="javascript:;" class="reduce_num"></a>
  						<input type="text" name="amount" value="<?php echo ($good["goods_buy_number"]); ?>" data="<?php echo ($good["goods_id"]); ?>" class="amount"/>
  						<a href="javascript:;" class="add_num"></a>
  					</td>
  					<td class="col5">￥<span></span></td>
  					<td class="col6"><a class="delete" data="<?php echo ($good["goods_id"]); ?>" href="javascript:;">删除</a></td>
