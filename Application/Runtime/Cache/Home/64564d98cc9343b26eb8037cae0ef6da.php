...
<body>
	...
	<div class="header w990 bc mt15">
      ...
      <?php if( strtolower(ACTION_NAME)== 'flow1' ): ?>
  			<div class="flow fr">
  				<ul>
  ...
  <hr>
	...
	<div class="fillin w990 bc mt15">
				...
				<table>
					...
					<tbody>
						...
						<?php if(is_array($goods)): $i = 0; $__LIST__ = $goods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$good): $mod = ($i % 2 );++$i;?><tr>
								<td class="col1"><a href=""><img src="<?php echo (ltrim($good["goods_small_logo"],'.')); ?>" alt="" /></a> 
								<strong><a target='_blank' href="<?php echo ($good["detail_url"]); ?>"><?php echo ($good["goods_name"]); ?></a></strong></td>
								<td class="col3">￥<?php echo ($good["goods_price"]); ?></td>
								<td class="col4"> <?php echo ($good["goods_buy_number"]); ?></td>
								<td class="col5"><span>￥<?php echo ($good["goods_total_price"]); ?></span></td>
						...
						<tr>
							<td colspan="5">
								<ul>
									...
									<li>
										<span>运费：</span>
										<em>￥<?php echo ($express); ?></em>
									</li>
									<li>
										<span>应付总额：</span>
										
										
										<em>￥<?php echo ($express + $total["price"]); ?></em>
									</li>
								</ul>
							</td>
						</tr>
		...
		<div class="fillin_ft">
			<a href="<?php echo U('order/add');?>"><span>提交订单</span></a>
			<p>应付总额：<strong>￥<?php echo ($express + $total["price"]); ?>元</strong></p>
